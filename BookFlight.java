...
public class BookFlight extends JFrame implements ActionListener {
    ...
    JButton bookflight, fetchButton, flight, payment;
    ...
    public BookFlight() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("airlinemanagementsystem/icons/detailsm.png" + ""));
        Image i2 = i1.getImage().getScaledInstance(450, 320, Image.SCALE_DEFAULT);
        ImageIcon image = new ImageIcon(i2);
        JLabel lblimage = new JLabel(image);
        lblimage.setBounds(650, 80, 500, 410);
        add(lblimage);
        ...
        payment.setBounds(220, 580, 150, 25);
        ...
        bookflight.setBounds(380, 580, 150, 25);
...
setExtendedState(JFrame.MAXIMIZED_BOTH);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == fetchButton) {
            ...
            // Open a new window with QR code image
            JFrame qrFrame = new JFrame("Payment QR Code");
            qrFrame.setSize(500, 600);
            qrFrame.setLocationRelativeTo(null);
            qrFrame.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
            
            ImageIcon qrImageIcon = new ImageIcon(ClassLoader.getSystemResource("airlinemanagementsystem/icons/payment.png"));
